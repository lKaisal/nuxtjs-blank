...
export default async (context) => {
  ...
  const detectBrowserLanguage = {"useCookie":true,"cookieKey":"i18n_redirected","alwaysRedirect":false,"fallbackLocale":null}
  ...
  app.i18n = new VueI18n({"messages":{"en":{"hello":"Hello world"},"ru":{"hello":"Привет мир"}},"silentTranslationWarn":true})
  app.i18n.locales = [{"name":"Russian","code":"ru","iso":"ru-RU","file":"ru-RU"},{"name":"English","code":"en","iso":"en-US","file":"en-US"}]
